...
#else
typedef struct mach_header_64 headerType;//对应Mach64 Header
typedef struct segment_command_64 segmentType;//Load Commands
typedef struct section_64 sectionType;//Section64
#endif
