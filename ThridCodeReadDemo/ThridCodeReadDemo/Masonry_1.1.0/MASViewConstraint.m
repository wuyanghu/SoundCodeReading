...
@property (nonatomic, readonly) NSMutableSet *mas_installedConstraints;//存储view的所有约束
...
- (void)setHasLayoutRelation:(BOOL)hasLayoutRelation{
    _hasLayoutRelation = hasLayoutRelation;
}
